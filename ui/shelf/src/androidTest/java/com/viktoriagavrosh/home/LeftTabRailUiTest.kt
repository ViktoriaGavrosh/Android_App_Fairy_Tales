...
import com.viktoriagavrosh.shelf.elements.LeftTabRail
...
class LeftTabRailUiTest {

    @get:Rule
    val composeTestRule = createAndroidComposeRule<ComponentActivity>()

    @Test
    fun leftTabRail_horizontalScreen_taleAnimalTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_taleFairyTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_talePeopleTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_folkPoemTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_folkCountingTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_folkLullabyTabIsSelected() {
    ...
    @Test
    fun leftTabRail_horizontalScreen_onlyOneTabIsSelected() {
        setContent(selectedTab = Tabs.TaleTab.Animal)
        composeTestRule.onNodeWithContentDescriptionForStringId(R.string.title_animal_tales)
            .assertIsSelected()
        composeTestRule.onNodeWithContentDescriptionForStringId(R.string.title_fairy_tales)
